...
%% Robot parameters
L = 0.3;   % Distance from center to wheel (meters)
%% Robot Speed
...
fr = (Vx*sin(pi/4) - Vy*cos(pi/4) - L*omega);
fl = (Vx*sin(3*pi/4) - Vy*cos(3*pi/4) - L*omega);
rl = (Vx*sin(5*pi/4) - Vy*cos(5*pi/4) - L*omega);
rr = (Vx*sin(7*pi/4) - Vy*cos(7*pi/4) - L*omega);
